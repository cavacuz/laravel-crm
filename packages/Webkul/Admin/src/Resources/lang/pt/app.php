...
return [
    'acl' => [
        'leads'           => 'Leads', // No accurate word for translation and people are used to use english word
        'lead'            => 'Lead', // No accurate word for translation and people are used to use english word
        'quotes'          => 'Cotações',
        'mail'            => 'Mail',
        ...
        'webhook'         => 'Webhook', // No accurate word for translation and people are used to use english word
        'contacts'        => 'Contatos',
        'persons'         => 'Pessoas',
        ...
        'pipelines'       => 'Pipelines', // No accurate word for translation and people are used to use english word
        'sources'         => 'Fontes',
        'types'           => 'Tipos',
        'email-templates' => 'Modelos de Email',
        'workflows'       => 'Fluxos de Trabalho',
        'other-settings'  => 'Outras Configurações',
        'tags'            => 'Tags', // No accurate word for translation and people are used to use english word
    ...
    'users' => [
        'activate-warning' => 'A Sua conta ainda não está ativada. Entre em contacto com o administrador.',
        'login-error'      => 'As credenciais não correspondem aos nossos registos.',

        'login' => [
            'email'                => 'Endereço de Email',
            'forget-password-link' => 'Esqueceu a senha?',
            'password'             => 'Senha',
            'submit-btn'           => 'Iniciar Sessão',
        ...
        'forget-password' => [
            ...
            'email-not-exist' => 'O Email Não Existe',
            'page-title'      => 'Esqueceu a Senha',
            'reset-link-sent' => 'Ligação para Redefinir a Senha enviada',
            'sign-in-link'    => 'Voltar a Iniciar Sessão?',
        ...
        'reset-password' => [
            'back-link-title'  => 'Voltar a Iniciar Sessão?',
    ...
    'account' => [
        'edit' => [
            ...
            'email'             => 'Email',
            'general'           => 'Geral',
            'invalid-password'   => 'A senha atual que inseriu está incorreta.',
            'name'              => 'Nome',
            'password'          => 'Senha',
            'profile-image'     => 'Imagem de Perfil',
            'save-btn'          => 'Gravar Conta',
            'title'             => 'A Minha Conta',
            'update-success'    => 'Conta atualizada com sucesso',
            'upload-image-info' => 'Carregar uma Imagem de Perfil (110px X 110px) em formato PNG ou JPG',
        ],
    ],
    ...
    'components' => [
        'activities' => [
            'actions' => [
                'mail' => [
                    ...
                    'title'        => 'Escrever Mail',
                    'to'           => 'Para',
                    'enter-emails' => 'Pressione Enter para adicionar destinatários',
                    'cc'           => 'CC', // No accurate word for translation and people are used to use english word
                    'bcc'          => 'BCC', // No accurate word for translation and people are used to use english word
                    'subject'      => 'Assunto',
                    'send-btn'     => 'Enviar',
                    'message'      => 'Mensagem',
                ],
                ...
                'activity' => [
                    ...
                    'call'          => 'Chamada',
                    'meeting'       => 'Reunião',
                    'lunch'         => 'Almoço', // not sure if that should be
                    'save-btn'      => 'Gravar Atividade',

                    'participants' => [
                        'title'       => 'Participantes',
                        'placeholder' => 'Escreva para procurar participantes',
                        'users'       => 'Utilizadores',
                        'persons'     => 'Pessoas',
            ...
            'index' => [
                ...
                'empty-placeholders' => [
                    'all' => [
                        ...
                        'description' => 'Nenhuma atividade encontrada para isto. Pode adicionar atividades clicando no botão no painel à esquerda.',
                    ],
                    
                    'planned' => [
                        'title'       => 'Nenhuma Atividade Planeada Encontrada',
                        'description' => 'Nenhuma atividade planeada encontrada para isto. Pode adicionar atividades planeadas clicando no botão no painel à esquerda.',
                    ],
                    
                    'notes' => [
                        'title'       => 'Nenhuma Nota Encontrada',
                        'description' => 'Nenhuma nota encontrada para isto. Pode adicionar notas clicando no botão no painel à esquerda.',
                    ],
                    
                    'calls' => [
                        'title'       => 'Nenhuma Chamada Encontrada',
                        'description' => 'Nenhuma chamada encontrada para isto. Pode adicionar chamadas clicando no botão no painel à esquerda.',
                    ],
                    
                    'meetings' => [
                        'title'       => 'Nenhuma Reunião Encontrada',
                        'description' => 'Nenhuma reunião encontrada para isto. Pode adicionar reuniões clicando no botão no painel à esquerda.',
                    ],
                    
                    'lunches' => [
                        'title'       => 'Nenhum Almoço Encontrado',
                        'description' => 'Nenhum almoço encontrado para isto. Pode adicionar almoços clicando no botão no painel à esquerda.',
                    ],
                    
                    'files' => [
                        'title'       => 'Nenhum Ficheiro Encontrado',
                        'description' => 'Nenhum ficheiro encontrado para isto. Pode adicionar ficheiros clicando no botão no painel à esquerda.',
                    ],
                    
                    'emails' => [
                        'title'       => 'Nenhum Email Encontrado',
                        'description' => 'Nenhum email encontrado para isto. Pode adicionar emails clicando no botão no painel à esquerda.',
                    ],
                    
                    'system' => [
                        'title'       => 'Nenhum Registro de Alterações Encontrado',
                        'description' => 'Nenhum registro de alterações encontrado para isto.',
                    ],
                ],
            ],
        ],
        ...
        'media' => [
            'images' => [
                ...
                'not-allowed-error' => 'Apenas são permitidos ficheiros de imagem (.jpeg, .jpg, .png, ..).',
                ...
                'placeholders' => [
                    ...
                    'zoom'      => 'Zoom', // No accurate word for translation and people are used to use english word
                ],
            ],

            'videos' => [
                'add-video-btn'     => 'Adicionar Video',
                'allowed-types'     => 'mp4, webm, mkv',
                'not-allowed-error' => 'Apenas são permitidos ficheiros de vídeo (.mp4, .mov, .ogg ..).',
            ],
        ],

        'datagrid' => [
            'index' => [
                'no-records-selected'              => 'Nenhum registo foi selecionado.',
